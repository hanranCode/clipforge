...
export const clone: NamespaceMessages = {
  zh: {
    ...
    cancelGen: "取消本次生成",
    // 参考视频真分析（场景切点→节奏骨架）
    refVideoLabel: "参考视频（推荐，可真实解析节奏）",
    refVideoBtn: "选择视频文件",
    refVideoReplace: "换一个视频",
    refVideoHint: "上传爆款视频文件（mp4/webm/mov，≤80MB），或从素材库里挑一条，将真实解析镜头切点与节奏",
    refLibraryBtn: "从素材库选择",
    refLibraryReplace: "换一条素材",
  ...
  en: {
    ...
    refVideoHint: "Upload the reference video (mp4/webm/mov, ≤80MB), or pick one from the asset library — shot cuts and pacing are analyzed for real",
    refLibraryBtn: "Choose from library",
    refLibraryReplace: "Pick another",
